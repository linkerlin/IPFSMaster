...
class ComposerStaticInit09fb51cddf53883e42f943aece77fbe8
{
    ...
    public static $classMap = array (
        'BrowseController' => __DIR__ . '/../..' . '/src/Controllers/BrowseController.php',
        'BrowseControllerTest' => __DIR__ . '/../..' . '/tests/BrowseControllerTest.php',
        'Composer\\InstalledVersions' => __DIR__ . '/..' . '/composer/InstalledVersions.php',
        'Controller' => __DIR__ . '/../..' . '/src/Controllers/Controller.php',
        'ControllerRenderTest' => __DIR__ . '/../..' . '/tests/ControllerRenderTest.php',
        'Database' => __DIR__ . '/../..' . '/src/Models/Database.php',
        'DatabaseEdgeCaseTest' => __DIR__ . '/../..' . '/tests/DatabaseEdgeCaseTest.php',
        'DatabaseIntegrationTest' => __DIR__ . '/../..' . '/tests/DatabaseIntegrationTest.php',
        'DatabaseTest' => __DIR__ . '/../..' . '/tests/DatabaseTest.php',
        'EdgeCaseTest' => __DIR__ . '/../..' . '/tests/EdgeCaseTest.php',
        'ErrorHandlingTest' => __DIR__ . '/../..' . '/tests/ErrorHandlingTest.php',
        'HomeController' => __DIR__ . '/../..' . '/src/Controllers/HomeController.php',
        'HomeControllerTest' => __DIR__ . '/../..' . '/tests/HomeControllerTest.php',
        'IPFSClient' => __DIR__ . '/../..' . '/src/Models/IPFSClient.php',
        'IPFSClientAdvancedTest' => __DIR__ . '/../..' . '/tests/IPFSClientAdvancedTest.php',
        'IPFSClientTest' => __DIR__ . '/../..' . '/tests/IPFSClientTest.php',
        ...
        'PerformanceTest' => __DIR__ . '/../..' . '/tests/PerformanceTest.php',
        ...
        'PinController' => __DIR__ . '/../..' . '/src/Controllers/PinController.php',
        'PinControllerTest' => __DIR__ . '/../..' . '/tests/PinControllerTest.php',
        'Router' => __DIR__ . '/../..' . '/src/Router.php',
        'RouterAdvancedTest' => __DIR__ . '/../..' . '/tests/RouterAdvancedTest.php',
        ...
        'SecurityTest' => __DIR__ . '/../..' . '/tests/SecurityTest.php',
        'SettingsController' => __DIR__ . '/../..' . '/src/Controllers/SettingsController.php',
        'SettingsControllerTest' => __DIR__ . '/../..' . '/tests/SettingsControllerTest.php',
        ...
        'UploadControllerTest' => __DIR__ . '/../..' . '/tests/UploadControllerTest.php',
        'ValidationTest' => __DIR__ . '/../..' . '/tests/ValidationTest.php',
    );

    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInit09fb51cddf53883e42f943aece77fbe8::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInit09fb51cddf53883e42f943aece77fbe8::$prefixDirsPsr4;
            $loader->classMap = ComposerStaticInit09fb51cddf53883e42f943aece77fbe8::$classMap;
